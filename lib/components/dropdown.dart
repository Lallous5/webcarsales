...
/* FlutterFlowDropDown can now take names to display text and pass values of ids */
    ...
    final dropdownWidget = DropdownButton<String>(
      ...
      items: effectiveOptions
          .map((e) => DropdownMenuItem(
                value: e,
                child: Text(
                  widget.names != null && widget.names!.isNotEmpty
                      ? widget.names![effectiveOptions.indexOf(e)]
                      : e,
